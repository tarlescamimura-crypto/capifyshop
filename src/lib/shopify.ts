...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "cu6q3f-gt.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "5bbe7f9e03bbff73d1c6d15271fceaac";
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: Pagamento necessário", {
      description: "A loja precisa de um plano ativo do Shopify. Acesse https://admin.shopify.com",
    });
    return;
  }
